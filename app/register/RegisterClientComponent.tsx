                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <select name="title" value={form.title} onChange={handleInputChange} className="w-full px-3 py-2 border border-gray-300 rounded-md text-black bg-white placeholder:text-gray-500">
                                        <option>Mr</option>
                                        <option>Mrs</option>
                                        <option>Ms</option>
                                        <option>Dr</option>
